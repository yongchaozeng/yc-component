<template>
    <div class="date-picker">
        <div class="input-wrapper" @mouseenter="showCancel = true" @mouseleave="showCancel = false">
            <img class="calendar-icon" src="../assets/imgs/calenda-box-icon.png" alt="">
            <div class="input" @click="togglePanel"
                 v-text="range ? value[0] + ' -- ' + value[1] : value?value:placeholder"></div>
            <transition name="fade">
                <img class="cancel-btn" src="../assets/imgs/close-filter.png" v-show="showCancel" @click="clear">
